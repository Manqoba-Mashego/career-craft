...
import { ClipboardList, CreditCard, Download, FileCheck, FileText, MessageSquare, Upload } from 'lucide-react';
import Reveal from './reveal';

const GeneralHowItWorks = () => {
  const steps = [
        {
...
export default GeneralHowItWorks