      ...
      <div className='w-[90%] max-w-7xl mx-auto flex flex-col gap-10'>
		...
		<Reveal className="md:w-4xl mx-auto" >
				<div className='bg-[#faf8f50d] border-[0.5px] border-[#8f7147] w- rounded-2xl p-14 flex flex-col gap-8'>
					...
					<div>
						<Link href="https://docs.google.com/forms/d/e/1FAIpQLSc5Kq3siizIADxEGE34pOF1vWZUqNEjfjzWrZO1ESDCtW97Zg/viewform" target='blank' className="shadow-[0_4px_10px_rgba(230,156,29,0.18),0_0_4px_rgba(230,156,29,0.15)]  flex mx-auto items-center bg-[#e69c1d] transition-all ease-out duration-300 text-[#0F2A4A] cursor-pointer hover:bg-[#e6b71d] px-10 py-4  rounded-xl gap-2 font-semibold w-fit"><span>Book CV Consultation</span> <ExternalLink size={15}/></Link>
