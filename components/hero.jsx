        ...
        <div className="relative h-screen bg-cover bg-center flex items-center justify-start bg-[url('/landing-page.jpg')]" >
            ...
            <div className="relative text-left text-white px-4 w-[90%] mx-auto">
                ...
                <div className='flex gap-2'>
                    <button className='bg-[#e69c1d] transition-all ease-in-out duration-300 text-[#0F2A4A] cursor-pointer hover:bg-[#e6c11d] text-[16px] px-10 py-4 flex rounded-xl gap-2'>Explore Services <ArrowRight /></button>
                    <button className='text-[#e69c1d] transition-all ease-in-out duration-300 border border-[#e69c1d] hover:bg-[#e69c1d] hover:text-[#0F2A4A] cursor-pointer rounded-xl px-10 py-4'>Book Consultation</button>
                </div>
            </div>
        </div>
    )
