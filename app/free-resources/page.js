...
const page = () => {
  return (
      <div className='bg-[#f3f3f34c] w-full h-screen relative '>
        <Link href={"/"} className='flex gap-2 items-center text-gray-600 hover:text-[#faa329] text-[16px] w-fit transition duration-150 absolute top-[100px] left-[40px] md:top-[120px] md:left-1/4'>
          <ArrowLeft size={18} />
